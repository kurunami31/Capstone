      ...
      <div style={{
        ...
        <div className="card-padding-mobile" style={{
          ...
          <div style={{
            ...
            fontSize: 13, lineHeight: 1.6, color: 'var(--label-color)',
          }}>
            <p style={{ margin: '0 0 12px', fontWeight: 600, color: 'var(--text-primary)', fontSize: 14 }}>
            ...
            <p style={{ margin: '0 0 6px', color: 'var(--text-primary)', fontWeight: 600 }}>What we collect:</p>
            ...
            <p style={{ margin: '0 0 6px', color: 'var(--text-primary)', fontWeight: 600 }}>How we protect it:</p>
            <ul style={{ margin: '0 0 12px', paddingLeft: 18 }}>
          ...
          <label style={{
            ...
            padding: '12px 16px', backgroundColor: 'var(--card-bg)',
            ...
            />
            <span style={{ fontSize: 13, color: 'var(--label-color)', lineHeight: 1.4 }}>
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: agreed ? '#2563eb' : 'var(--border-strong)',
