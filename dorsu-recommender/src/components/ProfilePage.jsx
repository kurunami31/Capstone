      ...
      <div style={{ maxWidth: 560, margin: '0 auto', padding: '32px 16px' }}>
        ...
        <div className="card-padding-mobile" style={{
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ position: 'relative' }}>
              <input type={showCurrentPwd ? 'text' : 'password'} value={currentPassword} onChange={e => setCurrentPassword(e.target.value)} placeholder="Enter current password"
                style={{ width: '100%', padding: '11px 14px', paddingRight: 40, fontSize: 14, backgroundColor: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: '#f1f5f9', outline: 'none', boxSizing: 'border-box' }} />
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div style={{ position: 'relative' }}>
              <input type={showNewPwd ? 'text' : 'password'} value={newPassword} onChange={e => setNewPassword(e.target.value)} placeholder="At least 8 characters"
                style={{ width: '100%', padding: '11px 14px', paddingRight: 40, fontSize: 14, backgroundColor: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: '#f1f5f9', outline: 'none', boxSizing: 'border-box' }} />
